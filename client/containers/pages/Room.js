            ...
            return (
                <div>
                    <section id="room-header" className="hero is-bold">
                        <div className="banner room-banner"
                             style={{backgroundImage: `url(${API_ROOT}/uploads/` + this.props.currentRoom.featuredImageId + ')'}}></div>
                            ...
                            <div className="container is-fluid">
                                <div className="columns">
                                    <div className="column">
                                        <h2 id="price" className="title is-2">${this.props.currentRoom.price} <span
                                            className="units" style={{fontSize: '20px'}}>/ Day</span></h2>
                                    ...
                                    <div className="column sidebar is-one-third">
                                        <div className="card">
                                            <div className="card-content">
                                                <h5 id="booked"
                                                    className="title is-5">{this.props.currentRoom.booked ? (<span
                                                    style={{color: '#e84c3d'}}>This room is booked!</span>) : 'Available for booking!'}</h5>
                                                {this.props.currentRoom.booked ? (
                                                    ...
                                                    this.props.currentUser ? (
                                                        this.props.currentUser.id === this.props.currentRoom.ownerId._id ? (
                                                            <button className="button is-text" disabled={'disabled'}>You
                                                                own this property!</button>
                                                        ) : (
                                                            <form>
                                                                <h6 className="subtitle is-6">Customize your
                                                                    booking</h6>
                                                                <Field
                                                                    key={'calendar'}
                                                                    label={'Select Dates'}
                                                                ...
                                                                <Field
                                                                    ...
                                                                    hasAddonRight={
                                                                        <div>
                                                                            ...
                                                                            <span
                                                                                className="incrementer-max">Max: {this.props.currentRoom.guests.adults}</span>
                                                                        </div>
                                                                    }
                                                                    hasAddonLeft={
                                                                        <a
                                                                ...
                                                                <Field
                                                                    ...
                                                                    hasAddonRight={
                                                                        <div>
                                                                            ...
                                                                            <span
                                                                                className="incrementer-max">Max: {this.props.currentRoom.guests.children}</span>
                                                                        </div>
                                                                    }
                                                                    hasAddonLeft={
                                                                        <a
                                                                ...
                                                                <div className="field is-horizontal">
                                                                    <label
                                                                        className="field-label is-normal">Price</label>
                                                        ...
                                                        <Link to="/signup/" className="button is-info">Signup to
                                                            Book!</Link>
                                                    )
                                                )}
                                            </div>
...
export default drizzleConnect(Room, mapStateToProps, mapDispatchToProps);
